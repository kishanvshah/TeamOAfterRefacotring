...
public class UserInterface extends javax.swing.JFrame {
    ...
    private UserInterfaceProduct userInterfaceProduct = new UserInterfaceProduct();
	/**
    ...
    private void initComponents() {
        ...
        userInterfaceProduct.setJDialog1(new javax.swing.JDialog());
        userInterfaceProduct.setJPanel10(new javax.swing.JPanel());
        userInterfaceProduct.setJLabel32(new javax.swing.JLabel());
        userInterfaceProduct.setJTextField32(new javax.swing.JTextField());
        userInterfaceProduct.setJButton11(new javax.swing.JButton());
        userInterfaceProduct.setJButton13(new javax.swing.JButton());
        ...
        dateOfPublicationLabel = new javax.swing.JLabel();
        isbnLabel = new javax.swing.JLabel();
        jLabel15 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        jTextField13 = new javax.swing.JTextField();
        //Modification------------------------------------------------------------
    //  jTextField13.setInputVerifier(new PassVerifier()); 
        ...
        userInterfaceProduct.bookFileComponent(this);
...
//Modification------------------------------------------------------------------------------------------------
        ...
        dateOfPublicationLabel.setText("Date of Publication:(MMMMM dd yyyy)*");
        ...
        jTextArea4.setEditable(false);    //kanwal
                ...
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel19Layout.createSequentialGroup()
                        .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(dateOfPublicationLabel, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanel19Layout.setVerticalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(dateOfPublicationLabel)
                    .addComponent(jTextField18, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//Modification----------------------------------------------------------------------------------
        ...
        jButton9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                data.jButton9ActionPerformed(evt);
            }
        });
        ...
        jButton10.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                userInterfaceProduct.jButton10MouseClicked(evt);
            }
        });
...
//Modification
    ...
    private void sam()
    {
        ...
        jTextArea2.setText("");
        jTextArea10.setText("");
        jTextArea9.setText("");jTextField13.setText("");
...
private void jPanel2ComponentShown(ComponentEvent evt) {             
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) { 
       ...
       boolean check = true;
        try{
         check = condition.jButton3Conditions(title,author,publisher,category,isbn,dateOfPublication); }
       ...
       if(check) {
            try {       
              ...
              String eror = condition.returnError();
              jTextArea4.setText(eror);
        }
     }
   ...
   private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {                                      
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {                                      
      ...
      boolean check = true;
       try{
        check = condition.jButton1Conditions(firstName,lastName,address,city,street,phone,mail,age,id); }
    ...
    public void jTextField32ActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            
  ...
  //Modification------------------------------------------------------------------------------------------------
    public void jButton13MouseClicked(java.awt.event.MouseEvent evt) {                                       
        try {
            getData().setBooksFileLocation(userInterfaceProduct.getJTextField32().getText());
            getBooks().setBooksArray(getData().readBooksFile());
           // if(getBooks().setBooksArray())
            if(booksize > 0){
            userInterfaceProduct.getJDialog1().setVisible(false);
            jDialog2.pack();
            jDialog2.setVisible(true);}
            else {
          JOptionPane.showMessageDialog(null,"Enter Valid Books File");
          userInterfaceProduct.getJDialog1().setVisible(true);
...
//Modification-------------------------------------------------------------------------
    private void jButton14MouseClicked(java.awt.event.MouseEvent evt) {                                       
      ...
      JOptionPane.showMessageDialog(null,"Enter Valid Members File");
      jDialog2.setVisible(true);   
      jButton15.requestFocus(); }
    }                                      
  ...
  //Modification-------------------------------------------------------------------------
    private void jButton16MouseClicked(java.awt.event.MouseEvent evt) {                                       
        try {
          ...
          JOptionPane.showMessageDialog(null,"Enter Valid Borrowing File");
          jDialog3.setVisible(true);
          jButton15.requestFocusInWindow(); 
          }
        } catch (ParseException ex) {
            Logger.getLogger(UserInterface.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void bookDataSize(int m) {
       booksize = m;
     // return booksize;
    }
...
userInterfaceProduct.loadFiles();
    }
 ...
 /* class PassVerifier extends InputVerifier {
         ...
         String title = jTextField13.getText();
           public boolean verify(JComponent input) {
               JTextField JTextField13 = (JTextField) input;
               return title.equals(JTextField13.getText());
           }
  }
*/
    /**
    ...
    private javax.swing.JLabel dateOfPublicationLabel;
    ...
    private void memebrFileComponent() {
       ...
       // setDefaultCloseOperation(jPanel20.);
    ...
    private void borrowFileComponent() {
