...
/**
 * This class manages various operations on members like add , delete ,display
 * 
 * @author Amr Nabil
 * 
 */
...
public class Members {
	 ...
	 */
	// Modification starts
	private static Member[] membersArray;
	// Modification ends
	/**
	 * array data size
	 */
   ...
   // Modification Ends
	...
	public String displayMembers() {
		...
		for (int i = 0; i < dataSize; i++) {
			counter++;
			message = message + counter + ")" + membersArray[i].getName()+" " +membersArray[i].getId()
					+ "\r\n";
		}
		if (counter == 0)
